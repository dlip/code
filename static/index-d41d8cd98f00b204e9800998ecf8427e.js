...
(function() {
  /* eslint-disable */
  var Ball, Block, Blocks, Breakout, Collision, KeyboardInput, MouseInput, Paddle, Screen, Sprite, Timer, Vector, breakout;

  Screen = class Screen {
    constructor(elem, width1, height1) {
      this.elem = elem;
      this.width = width1;
      this.height = height1;
...
//check blocks collision
  ...
  breakout = new Breakout(document.getElementById("coffeescript-breakout"));
